function EventsCard() {
  return (
    <div className='flex flex-row w-full rounded-2xl shadow-sm min-h-[150px] bg-olive-50 text-olive-900 border border-olive-200'>
      <div className='rest-card w-full flex flex-row justify-between items-center gap-2 border-b border-olive-400'>
        <div className='eventcard-left-wrapper flex flex-row justify-start items-start gap-2'>
          <div className='event-date-wrapper w-[100px]'>DATE</div>
